...
extension SupadartClient on SupabaseClient {
  ...
  SupabaseQueryBuilder get attendants => from('attendants');
  SupabaseQueryBuilder get position => from('position');
  SupabaseQueryBuilder get user_status => from('user_status');
