...
abstract class HomeRepo{
  ...
  Future<Either<Failure,List<Assets>>> getAssetsWithTicketID({required BigInt ticketId});
  Future<Either<Failure,List<Tickets>>> getTicketsWithAssetsID({required BigInt assetId});
