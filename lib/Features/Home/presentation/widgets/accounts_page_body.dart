                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [BoxShadow(color: AppColors.black.withAlpha(25),blurRadius: 10)]
                                  ),
                                  clipBehavior: Clip.antiAlias,
                                  child: ClipRRect(
                                    child: Image.asset(width: screenWidth,'assets/images/user.png',fit: BoxFit.cover,)
                                  ),
                                ),
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: AppTextStyle.latoRegular16(
                                          context,
                                        ).copyWith(color: AppColors.gray,overflow: TextOverflow.clip ),
                                      ),
                                    ],
                                  ),
                                ),
